...
public class RecordingAdapter extends RecyclerView.Adapter<RecordingAdapter.ViewHolder>{
    ...
    public RecordingAdapter(ArrayList<Recording> recordingArrayList){
    ...
    private void setUpData(ViewHolder holder, int position) {
        ...
        if( recording.isPlaying() ){
            holder.imageViewPlay.setImageResource(R.drawable.ic_pause_black_36dp);
            TransitionManager.beginDelayedTransition((ViewGroup) holder.itemView);
            holder.seekBar.setVisibility(View.VISIBLE);
            holder.seekUpdation(holder);
        }else{
            holder.imageViewPlay.setImageResource(R.drawable.ic_play_arrow_black_36dp);
            TransitionManager.beginDelayedTransition((ViewGroup) holder.itemView);
